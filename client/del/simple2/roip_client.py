"""
ROIP Client for HAM Radio - Full duplex with auto-reconnect
"""
    ...
    def transmit_audio(self):
        ...
        while self.transmitting and self.running:
            try:
                ...
                # Timing control - exactly 100ms between packets
            ...
            try:
                ...
                if len(data) == 808:
                    if not voice_active:
                        ...
                        voice_active = True
                        print(f"{time.strftime('%H:%M:%S')} VOICE ...", end='', flush=True)
